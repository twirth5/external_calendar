...
//        parent::afterMove($container); // TODO: Change the autogenerated stub
    ...
    public function sync()
    {
        ...
        // check events
        if ($ical->hasEvents()) {
            $events = SyncUtils::getEvents($this, $ical);

            if (!SyncUtils::checkAndSubmitModels($events, $this)) {
                throw new InvalidValueException(Yii::t('ExternalCalendarModule.sync_result', 'Error while check and submit models...'));
            }
        }
    }
}
